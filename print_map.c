...
void	print_sprite(t_data *img, int index_height, int index_width)
{
	if (img->map[index_height][index_width] == '1')
		img->sprite = mlx_xpm_file_to_image(img->mlx, "./asset/sprites/herbs.xpm", &img->img_width, &img->img_height);
	else if (img->map[index_height][index_width] == '0')
		img->sprite = mlx_xpm_file_to_image(img->mlx, "./asset/sprites/grass.xpm", &img->img_width, &img->img_height);
		...
		img->sprite = mlx_xpm_file_to_image(img->mlx, "./asset/sprites/ruby.xpm", &img->img_width, &img->img_height);
	else if (img->map[index_height][index_width] == 'E')
		img->sprite = mlx_xpm_file_to_image(img->mlx, "./asset/sprites/hole.xpm", &img->img_width, &img->img_height);
	else if (img->map[index_height][index_width] == 'M')
		img->sprite = mlx_xpm_file_to_image(img->mlx, "./asset/sprites/enemy.xpm", &img->img_width, &img->img_height);
}
